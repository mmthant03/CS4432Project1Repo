...
public class BufferMgr {
   ...
   /**
    * CS4432-Project1:
    * Since this is a wrapper class for BasicBufferMgr.java
    * this function just calls the toString method to BasicBufferMgr object
    * @return string information about all the buffer frames
    */
   @Override
